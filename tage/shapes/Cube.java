...
public class Cube extends ObjShape
{
	...
	{ 0.25f, 0.3333f,  0.0f, 0.3333f,  0.0f, 0.6667f, // back face
	0.0f, 0.6667f,  0.25f, 0.6667f,  0.25f, 0.3333f,
	0.25f, 1.0f,  0.5f, 1.0f,  0.25f, 0.6667f, // right face
	0.5f, 1.0f,  0.5f, 0.6667f,  0.25f, 0.6667f,
	0.75f, 0.6667f,  0.75f, 0.3333f,  0.5f, 0.6667f, // front face
	0.75f, 0.3333f,  0.5f, 0.3333f,  0.5f, 0.6667f,
	0.5f, 0.0f,  0.25f, 0.0f,  0.5f, 0.3333f, // left face
	0.25f, 0.0f,  0.25f, 0.3333f,  0.5f, 0.3333f,
	0.75f, 0.3333f,  0.75f, 0.6667f,  1.0f, 0.6667f, // bottom face
	1.0f, 0.6667f,  1.0f, 0.3333f,  0.75f, 0.3333f,
	0.25f, 0.3333f,  0.25f, 0.6667f,  0.5f, 0.6667f, // top face
	0.5f, 0.6667f,  0.5f, 0.3333f,  0.25f, 0.3333f };
